...
and next we have to apply this config on each machine we want to connect
...
##   Phase 2: Endpoint Visibility (Sysmon)
...
## Phase 3: SIEM: Splunk Enterprise (Official Download)

With telemetry generated by Sysmon, the next step was to centralize it.
Tools Used

   **SIEM:** [Splunk Enterprise (Official Download)](https://www.splunk.com/)
...
```
## Phase 4: Attack Simulation & Detection (Optional)
